  ...
  class AttackBoxLauncher {
    ...
    getTimeEstimate(session, progress) {
      ...
      if (status === 'provisioning') {
        ...
        if (stage === 'instance_starting' || session.stage_message?.includes('Starting')) {
        ...
        } else if (stage === 'waiting_health' || stage === 'waiting_health_checks') {
          // Health checks phase
          ...
          if (systemStatus === 'passed' && instanceStatus === 'passed') {
            return '⏱ ~5-10 seconds';
          } else if (systemStatus === 'initializing' || instanceStatus === 'initializing') {
