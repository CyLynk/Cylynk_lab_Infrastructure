...
/**
 * Flag submitted event for CyberLab.
 *
...
class flag_submitted extends \core\event\base
{
    ...
    {
        return get_string('eventflagsubmitted', 'mod_cyberlab');
    }
    ...
    {
        $result = $this->other['is_correct'] ? 'correct' : 'incorrect';
        return "The user with id '{$this->userid}' submitted a {$result} flag " .
            "for session '{$this->other['session_id']}' in cyberlab with id '{$this->objectid}'.";
    }
